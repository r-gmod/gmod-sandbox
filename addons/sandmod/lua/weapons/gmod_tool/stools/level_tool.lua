...
if CLIENT then
	language.Add("Tool.level_tool.name", "Level tool")
	language.Add("Tool.level_tool.desc", "Moves one prop's face to the level of second 2nd prop's face.")
	language.Add("Tool.level_tool.0",    "Primary: Level prop face 1 to face 2, Secondary: Level to a face below it, Reload: Level to a face above it")
	language.Add("Tool.level_tool.1",    "Now click another props face or a world face to level to. Press Reload to cancel.")
end

local function level_props(first_trace, trace)
	if not first_trace then return end
