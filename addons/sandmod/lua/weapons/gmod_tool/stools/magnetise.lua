...
if ( CLIENT ) then
	...
	language.Add("Magnet_Strength", "Strength")
	language.Add("Magnet_MaxObjects", "Max Objects")
	
	language.Add("Magnet_Alwayson", "Always On")
	language.Add("Magnet_Toggleon", "Toggle On")
	language.Add("Magnet_NoPull", "No Pull")
	language.Add("Magnet_AllowRotation", "Allow Rotation")
	language.Add("Magnet_group", "Key")
