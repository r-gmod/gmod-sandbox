...
TOOL.Name = "#tool.axislinedraw.listname"
TOOL.Command = nil
TOOL.ConfigName = nil
...
if CLIENT then
	...
	language.Add("tool.axislinedraw.name","Axis Linedraw")
	language.Add("tool.axislinedraw.listname","Axis - Linedraw")
	language.Add("tool.axislinedraw.desc", "Draw two segments, then the axis will go though their middles." )
	language.Add("tool.axislinedraw.0", "Left: Select the first prop.    Reload: Clear axis" )
	language.Add("tool.axislinedraw.1", "Left: Select the second prop.    Right: Previous" )
	language.Add("tool.axislinedraw.2", "Left: Draw the starting point of the 1st segment.    Right: Previous" )
	language.Add("tool.axislinedraw.3", "Left: Draw the ending point of the 1st segment.    Right: Previous" )
	language.Add("tool.axislinedraw.4", "Left: Draw the starting point of the 2nd segment.    Right: Previous" )
	language.Add("tool.axislinedraw.5", "Left: Draw the ending point of the 2nd segment.    Right: Previous" )
	language.Add("tool.axislinedraw.6", "Left: Validate.    Right: Previous" )
	
	language.Add("tool.axislinedraw.force", "Force Limit" )
	language.Add("tool.axislinedraw.torque", "Torque Limit" )
	language.Add("tool.axislinedraw.friction", "Friction" )
	language.Add("tool.axislinedraw.nocollide", "Nocollide" )
...
function TOOL.BuildCPanel(panel)
	panel:AddControl("Header",{Text = "#tool.axislinedraw.name", Description	= "#tool.axislinedraw.desc"})
	panel:AddControl("Slider",{Label = "#tool.axislinedraw.force",
								Description = "",
								Type = "Float",
								Min = 0,
								Max = 50000,
								Command = "axislinedraw_forcelimit" } )
	panel:AddControl("Slider",{Label = "#tool.axislinedraw.torque",
								Description = "",
								Type = "Float",
								Min = 0,
								Max = 50000,
								Command = "axislinedraw_torquelimit" } )
	panel:AddControl("Slider",{Label = "#tool.axislinedraw.friction",
								Description = "",
								Type = "Float",
								Min = 0,
								Max = 100,
								Command = "axislinedraw_hingefriction" } )
	panel:AddControl("CheckBox",{Label = "#tool.axislinedraw.nocollide", Description = "", Command = "nocollide"})
